...
The Bakey Shop application was created as a teaching tool for first-year students, with the purpose of introducing and providing practice in using Figma for designing the UI/UX of mobile applications.</p>
</div>
            </div>
            <div className="skills-list">
{ClassSkills.map((skill, index) => {
