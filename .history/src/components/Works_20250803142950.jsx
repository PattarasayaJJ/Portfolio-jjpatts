  ...
  return (
    <section className="projects-section">
      ...
      <div className="projects-container">
        ...
        {/* PTAH Project - มีหลายรูป */}
        <div className="minicard">
          <div className="final-project-card-text">
            <div className="final-project-content multiple-images">
              ...
              <div className="final-project-text-content">
                <p>
                  <span className='appname'>Physical Therapy At Home Application. </span>
        ...
        <div className="minicard">
          <div className="final-project-card-text">
            <div className="final-project-content">
              ...
              <div className="final-project-text-content">
                <p>
                  <span className='appname'>360streetview. </span>
        ...
        <div className="minicard">
          <div className="final-project-card-text">
            <div className="final-project-content">
              ...
              <div className="final-project-text-content">
                <p>
                  <span className='appname'>Doo Duang with Nong JJ. </span>
        ...
        <div className="minicard">
          <div className="final-project-card-text">
            <div className="final-project-content multiple-images">
              ...
              <div className="final-project-text-content">
                <p>
                  <span className='appname'>KKU Shuttle Bus. </span>
        ...
        <div className="minicard">
          <div className="final-project-card-text">
            <div className="final-project-content">
              ...
              <div className="final-project-text-content">
                <p>
                  <span className='appname'>Class Cafe. </span>
                  This project had a clear business objective: How can we increase this store's sales?<br />
        ...
        <div className="minicard">
          <div className="final-project-card-text">
            <div className="final-project-content">
              ...
              <div className="final-project-text-content">
                <p>
                  <span className='appname'>Bakery Shop. </span>
        ...
        <div className="minicard">
          <div className="final-project-card-text">
            <div className="final-project-content">
              ...
              <div className="final-project-text-content">
                <p>
                  <span className='appname'>9Diamond. </span>
